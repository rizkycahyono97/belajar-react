...
export default function UserRegister() {
  ...
  async function handleSubmit(e) {
    ...
    if (password !== confirmPassword) {
      await alertError("Password does'nt match");
      return;
    }
  ...
  return (
    <>
      <div className="animate-fade-in bg-gray-900 p-8 rounded-xl shadow-custom border border-gray-700 backdrop-blur-sm w-full max-w-md">
