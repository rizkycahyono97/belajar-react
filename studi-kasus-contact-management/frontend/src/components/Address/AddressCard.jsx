...
export default function AddressCard({ contactId, address, onDelete }) {
  return (
    <>
      <div
        key={address.id}
        className="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md border border-gray-600 card-hover mb-3"
      >
